            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 p-8 border border-gray-100">
                  ...
                  `}
                            ...
                            <p className="text-xs text-gray-400">Digite o DDD + número (ex: 11999999999)</p>
                        </div>
                  ...
                  `}
                        ...
                        <button
                            type="submit"
                            disabled={loading || success || !isNameValid || !isPhoneValid || !isEmailValid || !isPasswordValid || !passwordsMatch}
                            className={`
                w-full py-4 rounded-xl font-semibold text-white
                flex items-center justify-center gap-2
                transition-all duration-200
                ${loading || success || !isNameValid || !isPhoneValid || !isEmailValid || !isPasswordValid || !passwordsMatch
